...
The frontend will now send API requests to the selected backend environment.
...
6. **Use the body to explain *what* and *why*, not *how*** - the body must contain the reason of the commit, not how it's implemented.
