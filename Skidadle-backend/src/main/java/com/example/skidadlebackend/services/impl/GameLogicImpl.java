...
public class GameLogicImpl implements GameLogic {
  ...
  private CellRange searchSpace(
      GameState gs, int variable, int fixed, char ch, boolean isHorizontal) {
  ...
  private Position[] getMarkedCells(
      CellRange largestHorizontalWord, CellRange largestVerticalWord, int row, int col) {
